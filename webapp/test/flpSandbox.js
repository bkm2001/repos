		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#basicprojectname-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"basicprojectname-display": {
								"semanticObject": "basicprojectname",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=basicprojectname",
									"url": sap.ui.require.toUrl("basicprojectname")
								}
							}
						}
					}
